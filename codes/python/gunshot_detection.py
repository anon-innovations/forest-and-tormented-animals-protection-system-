...
labels = np.load(r"/home/nalaka/Desktop/Project_LoRa/Animal_detection/augmented_labels.npy")
...
def create_gunshot_wav_file(microphone_data, index, timestamp):
    librosa.output.write_wav("/home/nalaka/Desktop/Project_LoRa/Animal_detection/Gunshot Sound Sample #"
                            + str(index) + " ("
...
interpreter_1 = tf.lite.Interpreter(model_path = r"/home/nalaka/Desktop/Project_LoRa/Animal_detection/1D.tflite")
...
interpreter_2 = tf.lite.Interpreter(model_path = r"/home/nalaka/Desktop/Project_LoRa/Animal_detection/128_x_64_2D.tflite")
...
interpreter_3 = tf.lite.Interpreter(model_path = r"/home/nalaka/Desktop/Project_LoRa/Animal_detection/128_x_128_2D.tflite")
